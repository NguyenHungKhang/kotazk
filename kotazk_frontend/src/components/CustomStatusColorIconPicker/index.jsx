...
const CustomStatusColorIconPicker = ({ name }) => {
    const theme = useTheme();
    const [anchorEl, setAnchorEl] = useState(null);
    const [selectedIcon, setSelectedIcon] = useState("IconCircleDot");
    const [selectedColor, setSelectedColor] = useState("#FF7369");
    ...
    return (
        <div>
            ...
            >
                ...
                <Typography color={theme.palette.getContrastText(selectedColor)}>
                    {name}
                </Typography>
            </Stack>
...
export default CustomStatusColorIconPicker;
